...
python src/prune/erazr_reverse_compressed.py \
    --report_to none \
    --do_train \
    --do_eval \
    ...
    --output_dir ./data/runs/erazr-reverse-compressed-mean_k${COMPRESSION_DIM}-elr${ELR}-llr${LLR}-relr${RELR}-rllr${RLLR}-es${EDGE_SPARSITY}-ns${NODE_SPARSITY}-t${TOTAL}/ \
