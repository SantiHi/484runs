...
from modeling_fllama import FLlamaForCausalLM as FLlamaForCausalLMOriginal
from modeling_fllama_compressed import FLlamaForCausalLM
...
def main():
    ...
    model = FLlamaForCausalLM.from_pretrained(
        ...
        compression_dim=model_args.compression_dim,
        compression_init=model_args.compression_init,
        freeze_projections=model_args.freeze_projections,
    )
    ...
    llama_model = FLlamaForCausalLMOriginal.from_pretrained(
